...
<nav>
    ...
    <div id="choiceDiv">
        ...
        <button type="button" class="choices" onclick="inputData()">Input patient data</button>
        <button type="button" class="choices" onclick="retrieveData()">Retrieve patient data</button>
    </div>
